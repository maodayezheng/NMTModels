...
class Seq2SeqAttention(object):
    ...
    def target_decode_step(self, target_embedding, h1, h2, o, a_c1, a_c2, mask):
        ...
        return h1, h2, o, attention_content, attention_score
    ...
    def greedy_decode_step(self, target_embedding, h1, h2, o, a_c1, a_c2, mask):
        h1, h2, o, attention_content, a_s = self.target_decode_step(target_embedding, h1, h2, o, a_c1, a_c2, mask)
        ...
        return prediction_embedding, h1, h2, o, prediction, a_s
    ...
    def decode_fn(self):
        ...
        ([h_d_1, h_d_2, d_o, attention_content, att_s], update) = theano.scan(self.target_decode_step,
                                                                                outputs_info=[decode_init[:, :self.hid_size],
                                                                                     decode_init[:, self.hid_size:],
                                                                                     o_init, None, None],
                                                                       sequences=[target_input_embedding],
        ...
        ([e, h1, h2, o, greedy_p, att_score], update) = theano.scan(self.greedy_decode_step,
                                                                    outputs_info=[init_embedding, decode_init[:, :self.hid_size],
                                                                                  decode_init[:, self.hid_size:], o_init, None, None],
                                                                    non_sequences=[attention_c1, attention_c2, encode_mask],
                                                                    n_steps=51)

        return theano.function(inputs=[source, target],
                               outputs=[greedy_p, att_score],
